...
class Journal(models.Model):
    ...
    description = models.TextField(max_length=1000, help_text="A short description shown on list pages")
    ...
    about = models.TextField(max_length=1000, blank=True, help_text="All about the journal displayed on journal page")
